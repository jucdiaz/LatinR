...
\begin{center}
  ...
  \begin{minipage}{0.16\linewidth}
    \begin{flushright}
     \textbf{ Juan Camilo Díaz Zapata}\\
			twitter: @jkmilodiaz \\
			\textbf{Freddy Hernández Barajas}\\
			twitter: @fhernanb74 \\
      \textit{Escuela de Estadística}\\
		\textit{Universidad Nacional de Colombia, Medellín}\\
    \end{flushright}
  \end{minipage}
\end{center}
...
La integración de los modelos estadísticos en un paquete del sistema computacional \textit{R} permite que la utilización de los modelos estadísticos a problemas aplicados sea de gran facilidad para la comunidad estadística. 
  \end{minipage}
}
...
{\LARGE
\begin{center}
\textbf{Distribución ZOIP (Zeros Ones Inflated Proporcional)}
\end{center}
}
...
%\colorbox{marronrp3}{
  %\begin{minipage}[t]{.96\linewidth} 
\begin{center}
\LARGE{\textbf{Estimación vía máxima verosimilitud y AGHQ}}
\end{center}
...
Para encontrar el punto máximo de la función de log-verosimilitud anterior, es necesario rea\-li\-zar una aproximación por medio de la cuadratura de Gauss-Hermite adaptativa con o sin \textit{pruning}
...
\end{center}
			    \vspace{.02cm}
El paquete \textit{ZOIP} de \textit{R} es útil para ajustar distribución ZOIP, modelos de regresión de efectos fijos y mixtos para datos proporcionales inflados con ceros y/o unos. Estas son las principales funciones: \\ %\medskip
\begin{center}
...
El modelo propuesto se puede reescribir con los par\'{a}metros estimados por medio del paquete  \texttt{ZOIP} y la función  \texttt{RMM.ZOIP}, as\'{\i}:
...
\colorbox{SeaGreen}{
  \begin{minipage}[t]{.96\linewidth} 
\begin{center}
{\LARGE \textbf{Estudio de simulación: Modelo regresión ZOIP mixto}}
\end{center}
			    \vspace{.02cm}
					
El modelo de regresión ZOIP mixto en el cual se basa el estudio de simulación esta dado por \eqref{A_eq_reg_mix2} y el esquema de simulacion es:
					 \end{minipage}
					}
...
En el estudio de simulación se plantearon 18 escenarios de simulaci\'{o}n y se realizaron 1000 r\'{e}plicas en cada escenario, dando como resultado:
...
\end{tabular}
\caption{Resultados del estudio de simulación}
...
\begin{enumerate}
	\item El paquete \textit{ZOIP} se implementan diferentes funciones, con el objetivo de que sean utilizados los modelos de regresión ZOIP por un usuario. Dicho paquete muestra convergencia de sus funciones desarrollados, por medio de los estudios de simulación.
...
%\begin{flushleft}
%\begin{itemize}
	%\item El consumo de bebidas energizantes en los estudiantes de la Universidad Nacional de Colombia  Sede Medellín depende o se ve afectado principalmente por el semestre y el género.\\
	%\item Según las pruebas de Bondad de Ajuste, con un nivel de significancia del $0.05$, el modelo Probit parece ser adecuado para pronosticar la probabilidad de que un estudiante consuma Bebidas Energizantes.\\
%\end{itemize}
%\end{flushleft}
...
%
%\bibitem Falissard, Bruno (2012), Analysis of Questionnaire data with R,  EdiCRC Press, 2012, p. 51-54, 89-97.  ISBN 978-1-4398-1766-7.
%
%\bibitem Sarndal, Carl; Swensson, Bengt; Wretman, Jan (1992), Model assisted survey sampling, Springer, 1992. Págs 494-500. ISBN 0-387-97528-4
%
%\bibitem Scheaffer, Richard; Mendenhall, William; Ott, Lyman (2007), Elementos de Muestreo, sexta edición. Editorial Thomson. 2007 ISBN 84-9732-493-5
%
%
%\bibitem Iglesias, Tania (2012-2013). Métodos de Bondad de Ajuste en Regresión Logística. Máster Oficial en Estadística Aplicada. 
%
%
%\end{thebibliography}
